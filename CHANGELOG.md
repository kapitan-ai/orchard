...
- Grouped patch/minor dependency updates: cowboy 2.18.0 / cowlib 2.19.0 / gun 2.5.0 / ranch 2.2.1 (clearing three cowboy advisories), openspec CLI 1.9.0, and Python lockfile refreshes (huggingface-hub 1.27, grpcio 1.83, and friends). ([#282](https://github.com/kapitan-ai/orchard/pull/282))
