defmodule Orchard.Governance.PortalLoginThrottle do
  @moduledoc """
  Per-identity and per-source failed-login backoff state.

  Fingerprints are HMAC-SHA-256 digests. Raw slugs, emails, and IPs are never stored.
  """
  ...
  schema "portal_login_throttles" do
    ...
    field(:identity_fingerprint, :binary, primary_key: true)
