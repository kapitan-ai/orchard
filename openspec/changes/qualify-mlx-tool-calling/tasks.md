...
- [ ] 2.3 Exercise the actual pinned MLX-LM parser and real-model tool generation with the existing pinned runtime.
...
- [ ] 3.1 Add reusable qualification coverage and model prerequisites; verify a real OpenCode Chat Completions tool-result round trip with exact model/runtime/client identities.
