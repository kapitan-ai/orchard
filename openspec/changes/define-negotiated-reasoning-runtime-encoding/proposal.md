...
- Record the concrete protocol source declarations that realize them — their enum values, `nil`-presence encoding, service and RPC declaration ownership, message layouts, and execution-redemption shape — as blocked pending owner-approved schema design. This PR adds no protocol source declaration or generated binding.
