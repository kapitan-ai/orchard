...
Automatic retry SHALL pin all eleven tuple fields and require a different endpoint to provide fresh live evidence and a new preparation proof for the same tuple. It SHALL not pin attempt-local authorization, preparation identity, selected profile, or worker incarnation.
