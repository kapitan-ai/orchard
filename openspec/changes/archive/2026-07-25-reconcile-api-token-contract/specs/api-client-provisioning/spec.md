...
### Requirement: First-admin evidence covers independent contention and log redaction
...
Post-mint output failure SHALL retain only non-secret recovery evidence.
