# support-bundle-retirement Specification

## Purpose
Define Orchard's pre-release retirement of support bundles while preserving generic diagnostics, historical audit records, existing operator-owned artifacts, and the retained `support/` lifecycle namespace.
## Requirements
