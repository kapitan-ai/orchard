# dispatch-capacity Specification

## Purpose
Define Orchard's durable Controller dispatch-capacity authority and policy evidence, pure shared evaluation, atomic admission policy persistence, Controller capability evidence, and operator diagnostics.
...
Orchard MUST NOT provide a repository operation that advances the durable enforcement phase or any dispatch-capacity policy to `enforcing`.
