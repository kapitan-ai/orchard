# request-deadline-ceiling Specification

## Purpose
Define deployment-owned ceilings for effective request deadlines and fail-closed handling of incoherent or stale policy values.
