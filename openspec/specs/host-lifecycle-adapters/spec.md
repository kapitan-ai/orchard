...
Defines the portability boundary that isolates platform-native host lifecycle implementations from Orchard's portable core without claiming an unimplemented managed Node Agent replacement protocol.
