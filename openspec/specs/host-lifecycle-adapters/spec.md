...
Defines the platform-neutral safety contract for externally managed Orchard host processes, including exclusion, observation, fencing, launch authorization, normalized lifecycle evidence, and isolation of platform-native implementations.
