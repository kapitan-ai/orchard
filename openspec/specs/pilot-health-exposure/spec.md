# pilot-health-exposure Specification

## Purpose
Define the split between status-only public health endpoints and authenticated operator diagnostics, together with strict CLI and Console consumers.
